...
class Consola {
	...
	int deslx,desly;//deslocamento vertical e horizontal
...
public:
	...
	void setCellcolor(int x,int y, WORD color,string tipo,int id);
	int getsizex();
	int getsizey();
	int getdeslx();
	int getdesly();
	int setdeslx(int d,int lim);
	int setdesly(int d,int lim);
};
